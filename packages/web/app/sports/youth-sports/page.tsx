...
export default function YouthSportsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* CRITICAL: Demo Mode Warning Banner */}
      <div className="mb-6 bg-red-50 border-2 border-red-500 rounded-lg p-6 shadow-lg">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-red-900 mb-2">⚠️ DEMO MODE: Simulated Data Only</h3>
            <div className="space-y-2 text-sm text-red-800">
              <p className="font-semibold">
                This youth sports data is <strong className="underline">entirely simulated</strong> for development and demonstration purposes.
              </p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li><strong>All team names, player statistics, and game scores are randomly generated</strong></li>
                <li>Data uses Math.random() and does not reflect actual youth athlete performance</li>
                <li>DO NOT use this data for scouting, recruiting, or player evaluation decisions</li>
                <li>Real integration with MaxPreps and Perfect Game APIs is pending</li>
              </ul>
              <p className="mt-3 pt-3 border-t border-red-300 font-medium">
                For actual youth sports data, please visit official sources:
                <a href="https://www.maxpreps.com" target="_blank" rel="noopener noreferrer" className="ml-2 text-red-700 hover:text-red-900 underline">
                  MaxPreps (HS Football)
                </a> •
                <a href="https://www.perfectgame.org" target="_blank" rel="noopener noreferrer" className="ml-2 text-red-700 hover:text-red-900 underline">
