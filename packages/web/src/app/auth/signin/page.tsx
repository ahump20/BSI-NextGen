    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="max-w-md w-full p-8 bg-gray-900 rounded-lg shadow-xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blaze-orange mb-2">
            Blaze Sports Intel
          </h1>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={isLoading !== null}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gray-800 text-white rounded-lg font-medium hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading === 'github' ? (
        ...
        <div className="mt-6 text-center">
          <a href="/" className="text-sm text-blaze-orange hover:underline">
            Back to Home
          </a>
        </div>
      </div>
