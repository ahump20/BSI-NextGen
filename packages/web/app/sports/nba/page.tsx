...
export default function NBAPage() {
  ...
  // Sort divisions in order: Eastern (Atlantic, Central, Southeast), Western (Northwest, Pacific, Southwest)
  const divisionOrder = [
    'Eastern Atlantic',
    'Eastern Central',
    'Eastern Southeast',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link
                href="/"
                className="text-2xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent hover:from-orange-700 hover:to-red-700 transition-all"
              >
                Blaze Sports Intel
              </Link>
            ...
            {!authLoading && (
              <>
                {authenticated && user ? (
                  ...
                  <Link
                    href="/login"
                    className="px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg hover:from-orange-700 hover:to-red-700 transition-all font-medium"
                  >
                    Sign In
                  </Link>
                )}
